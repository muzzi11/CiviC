...
\\\\
Loop unswitching by moving the if statements out of the loop is not possible due to the if expression being loop variant. A possible optimization that can work, with a bit of magic, is the following:
...
\end{lstlisting}
This does not preserve the order of execution, but this is not a problem in this specific piece of code.
